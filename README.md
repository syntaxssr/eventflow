...
- **Reset เมื่อ Refresh** — ระบบไม่ใช้ `localStorage`/`sessionStorage` เลย refresh เมื่อใดข้อมูลกลับเป็น Mock Data เริ่มต้นและต้อง login ใหม่ (พฤติกรรมที่ตั้งใจตามสเปก)
