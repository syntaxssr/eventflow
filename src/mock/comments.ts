...
export const MOCK_COMMENTS: Comment[] = [
  ...
  },
  {
    ...
    authorId: "u-1",
    body: {
      th: "@ธนกฤต วงศ์อนันต์ ช่วยยืนยันกับโรงพิมพ์อีกทีว่าแบ็คดรอปใช้ขนาด 6x3 เมตร แล้วส่งใบเสนอราคาเข้ามาในงานนี้ด้วยนะคะ",
      en: "@Thanakrit Wonganan please double-check with the printer that the backdrop is 6x3 m and drop the quotation into this task.",
    },
    parentId: "c-1",
    mentionIds: ["u-2"],
    attachments: [],
  ...
  /* ---- t-6: สรุปเมนูอาหารกับโรงแรม ---- */
  {
    ...
    authorId: "u-5",
    body: {
      th: "@พิมพ์ชนก อารีย์ ยอดล่าสุด มังสวิรัติ 6 ที่ ฮาลาล 9 ที่ ขอให้ยืนยันกับโรงแรมภายในศุกร์นี้นะคะ งบยังอยู่ในกรอบ",
      en: "@Pimchanok Aree latest count is 6 vegetarian and 9 halal seats — please confirm with the hotel by this Friday. Still within budget.",
    },
    parentId: null,
    mentionIds: ["u-7"],
    attachments: [],
  ...
  /* ---- t-8: สรุปยอดจองโต๊ะรอบแรก ---- */
  {
    ...
    authorId: "u-1",
    body: {
      th: "@สิริพร ใจดี ขอไฟล์สรุปยอดจองโต๊ะรายแผนกจากระบบหน่อยค่ะ จะเอาไปวางผังที่นั่งต่อ",
      en: "@Siriporn Jaidee could you pull the per-department booking summary from the system? Need it for the seating chart.",
    },
    parentId: null,
    mentionIds: ["u-3"],
    attachments: [],
  ...
  /* ---- t-15: ตรวจสอบระบบเสียงและแสง ---- */
  {
    ...
    authorId: "u-1",
    body: {
      th: "@อนุชา พงษ์ไพบูลย์ ทีมเทคนิคโรงแรมขอเลื่อนทดสอบระบบเป็นบ่ายสอง วันเดิม สะดวกไหมคะ",
      en: "@Anucha Pongpaiboon the hotel's technical team asked to move the rig test to 2 pm same day — does that work?",
    },
    parentId: null,
    mentionIds: ["u-4"],
    attachments: [],
  ...
  /* ---- t-17: จัดทำลำดับพิธีการ (Run Down) ---- */
  {
    ...
    authorId: "u-1",
    body: {
      th: "@ณัฐวุฒิ แสงทอง ร่าง Run Down รอบสองอยู่ในแท็บไฟล์แล้ว ช่วงมอบรางวัลขยับไป 19:45 ตามที่ประชุมกันนะคะ",
      en: "@Nattawut Sangthong the second run-down draft is in the Files tab — the awards segment moves to 19:45 as agreed.",
    },
    parentId: null,
    mentionIds: ["u-6"],
    attachments: [],
