 ...
 *
 * ข้อมูลธุรกิจที่เทสต์สร้างอยู่ใน memory การ `page.goto()` จะทำให้ข้อมูลเหล่านั้น
 * กลับเป็น Mock เริ่มต้น แม้ session ที่เลือกจดจำไว้จะยังอยู่ จึงต้องเดินผ่าน UI
 * จริงเพื่อรักษาสถานะของ flow
 *
